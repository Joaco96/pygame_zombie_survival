...
def create_vault(settings,imagen:pygame.Surface = None):
...
def create_bullet(settings,origen:tuple[int,int], target:tuple[int,int],imagen:pygame.Surface = None,vault_bullet=False):
